...
void main() {
  group('Navigation', () {
    ...
    testWidgets('PageHeader shows title and back', (tester) async {
      var back = false;
      await tester.pumpWidget(_wrap(
        PageHeader(title: 'Quiz', onBack: () => back = true),
      ));
  ...
  group('Trail', () {
    ...
    testWidgets('PathNode renders label', (tester) async {
      await tester.pumpWidget(_wrap(
        const PathNode(state: PathNodeState.active, label: 'Level 1'),
      ));
  ...
  group('Game', () {
    testWidgets('PromptCard shows text', (tester) async {
      await tester.pumpWidget(_wrap(
        const PromptCard(eyebrow: 'Q1', text: 'What is 2+2?'),
      ));
  ...
  group('Feedback & dialogs', () {
    ...
    testWidgets('FloatingNotice shows child', (tester) async {
      await tester.pumpWidget(_wrap(
        FloatingNotice.amount(text: '+10 pts'),
      ));
