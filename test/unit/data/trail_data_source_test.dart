...
void main() {
  ...
  late RemoteTrailDataSource sut;

  setUp(() {
    apiClient = MockApiClient();
    sut = RemoteTrailDataSource(apiClient);
  });

  test('fetchBootstrap parses English RPC JSON into TrailBootstrapData', () async {
    when(
    ...
    verify(apiClient.rpc<Map<String, dynamic>>('get_trail_bootstrap')).called(1);
  });

  test('fetchGameTrails parses nested English JSON into GameTrailData', () async {
    when(
