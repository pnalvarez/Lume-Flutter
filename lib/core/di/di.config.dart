...
import 'package:lume/layers/domain/usecases/get_submodule_games.dart' as _i96;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i101.IApiClient>(() => _i101.ApiClient.fromInjection());
    ...
    gh.factoryAsync<_i96.IGetSubmoduleGames>(
      () async =>
          _i96.GetSubmoduleGames(await getAsync<_i131.IGameRepository>()),
    );
